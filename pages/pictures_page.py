...
class PicturesPage(BasePage):
    ...
    def should_be_correct_category_name(self):
        return self.find_element(*PicturesPageLocators.CATEGORY_NAME).get_attribute('value')
    ...
    def get_category_name(self):
        category_name = self.find_element(*PicturesPageLocators.FIRST_CATEGORY).text
        return category_name

    def get_picture_link(self):
        picture_link = self.find_element(*PicturesPageLocators.PICTURE_LINK).get_attribute("src")
        return picture_link
